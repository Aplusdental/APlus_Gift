...
<head>
    ...
    <title>A+ Dental Center - NFC Smart Card</title>
...
<body class="text-slate-100 relative pb-12 selection:bg-aplusCyan-400 selection:text-slate-900">
    ...
    <div class="relative z-10 max-w-md mx-auto px-4 pt-8 pb-20">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-2">
                <span class="w-2.5 h-2.5 rounded-full bg-aplusCyan-400 animate-pulse"></span>
                <span class="text-xs font-medium text-aplusCyan-300 tracking-wider">A+ Dental Center NFC Card</span>
            </div>
            <span class="text-[10px] bg-aplusNavy-900/90 text-aplusCyan-300 border border-aplusCyan-400/30 px-2.5 py-1 rounded-full font-bold">احجز موعدك الآن</span>
        </div>
        ...
        <div class="text-center mb-6">
            ...
            <div class="mt-4 p-3 rounded-xl glass-card border border-aplusCyan-400/20 max-w-xs mx-auto">
                <p class="text-xs text-aplusCyan-300 leading-relaxed font-medium">
                    <i class="fa-regular fa-clock text-aplusGold-400 ml-1"></i> مواعيد العمل: يومياً بأفضل عناية طبية
                </p>
            </div>
        </div>
        ...
        <div class="space-y-3 mb-6">
            ...
            <div class="grid grid-cols-1 gap-2.5">
                <a id="btnLocKafr" href="https://maps.google.com" target="_blank" class="glass-card rounded-xl p-3.5 flex items-center justify-between hover:bg-aplusNavy-800/50 hover:border-aplusCyan-400/50 transition-all group">
                    <div class="flex items-center gap-3">
        ...
        <div class="mb-6">
            <a id="btnReview" href="https://g.page" target="_blank" class="glass-card rounded-2xl p-4 border border-aplusCyan-400/30 hover:bg-aplusNavy-800/40 transition-all flex items-center justify-between group">
                <div class="flex items-center gap-3">
        ...
        <div class="space-y-3 mb-6">
            ...
            <div class="grid grid-cols-4 gap-2">
                ...
                <!-- Facebook Page Link -->
                <a id="btnFacebook" href="https://www.facebook.com/aplusdentalcenter" target="_blank" class="glass-card rounded-xl p-2.5 flex flex-col items-center justify-center gap-1.5 hover:bg-aplusNavy-800/40 hover:border-blue-500/50 transition-all group">
                ...
                <!-- Instagram Link -->
                <a id="btnInstagram" href="https://www.instagram.com/aplus.77" target="_blank" class="glass-card rounded-xl p-2.5 flex flex-col items-center justify-center gap-1.5 hover:bg-aplusNavy-800/40 hover:border-pink-500/50 transition-all group">
        ...
        <div class="glass-card bg-aplusNavy-950 border border-aplusCyan-400/50 rounded-2xl w-full max-w-md p-5 space-y-4 text-right max-h-[90vh] overflow-y-auto">
            ...
            <div class="space-y-3 text-xs">
                ...
                <div>
                    ...
                    <input type="text" id="inputTitle" placeholder="اتركه فارغاً للإبقاء على الحالي" class="w-full bg-aplusNavy-900/80 border border-aplusNavy-800 rounded-lg p-2.5 text-slate-100 focus:outline-none focus:border-aplusCyan-400">
                </div>
    ...
    <script>
        const defaultConfig = {
            ...
            facebook: "https://www.facebook.com/aplusdentalcenter",
        ...
        function applyConfigToUI() {
            ...
            document.getElementById('btnBooking').href = cleanWa ? `https://wa.me/${cleanWa}?text=${encodeURIComponent('مرحباً A+ Dental Center، أرغب في الاستفسار وحجز موعد للكشف')}` : '#';
            document.getElementById('btnPhone').href = cleanWa ? `tel:+${cleanWa}` : '#';
            document.getElementById('btnFacebook').href = currentConfig.facebook || 'https://www.facebook.com/aplusdentalcenter';
